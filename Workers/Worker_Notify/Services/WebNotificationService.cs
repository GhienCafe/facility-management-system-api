...
public interface IWebNotificationService : IBaseService
{
    Task SendMaintenance(TimeSpan timeSpan);
}
public class WebNotificationService : BaseService, IWebNotificationService
{
    private readonly ISendNotification _sendNotification;

    public WebNotificationService(MainUnitOfWork mainUnitOfWork, IHttpContextAccessor httpContextAccessor, IMapperRepository mapperRepository, ISendNotification sendNotification) : base(mainUnitOfWork, httpContextAccessor, mapperRepository)
    {
        _sendNotification = sendNotification;
    }
    public async Task SendMaintenance(TimeSpan timeSpan)
    {
         try
            {
